...
export default function SignupPage() {
  return (
    <div className="bg-surface-container-lowest rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full max-w-[440px] p-8 md:p-10 flex flex-col my-8">
      ...
      <p className="text-on-surface-muted text-label-lg md:text-body-md mb-8 leading-relaxed">
        ...
        <div className="flex gap-4">
          <div className="flex flex-col gap-1.5 flex-1">
            ...
            <input 
              type="text" 
              placeholder="Jane"
              className="w-full h-[48px] px-4 rounded-xl border border-surface-variant bg-surface-container-lowest text-body-md text-on-surface placeholder:text-outline-variant focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
            />
          </div>
          <div className="flex flex-col gap-1.5 flex-1">
            <label className="text-label-sm font-bold text-on-surface">
